# Создаем основную панель с карточками
main_panel_content = '''"""
...
with open("components/main_panel.py", "w", encoding="utf-8") as f:
    f.write(main_panel_content)

print("Файл components/main_panel.py создан")