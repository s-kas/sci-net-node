...
with open("components/ris_parser.py", "w", encoding="utf-8") as f:
    f.write(ris_parser_content)

print("Файл components/ris_parser.py создан")